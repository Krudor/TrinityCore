...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_SEL_CHALLENGE_MODE_GROUPS,
    CHAR_SEL_CHALLENGE_MODE_GROUP,
    CHAR_INS_CHALLENGE_MODE_GROUP,
    CHAR_SEL_CHALLENGE_MODE_REALM_LEADERBOARDS,
    CHAR_SEL_CHALLENGE_MODE_GUILDS,
    CHAR_SEL_CHALLENGE_MODE_GUILD_LEADERBOARDS,
    ...
    CHAR_SEL_CHALLENGE_MODE_MEMBERS,
    CHAR_INS_CHALLENGE_MODE_MEMBERS,
    CHAR_SEL_CHALLENGE_MODE_MEMBERS_FOR_ATTEMPT,
