...
void GroupMgr::LoadGroups()
{
    ...
    TC_LOG_INFO("server.loading", "Loading Group instance saves...");
    {
        ...
        do
        {
            ...
            InstanceSave* save = sInstanceSaveMgr->AddInstanceSave(mapEntry->ID, fields[2].GetUInt32(), Difficulty(diff), time_t(fields[5].GetUInt32()), fields[6].GetUInt16(), fields[7].GetUInt64() != 0, true);
