...
#define DEFINE_OPCODE_HANDLER_OLD(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CMSG_CHALLENGE_MODE_REQUEST_LEADERS,                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::ChallengeMode::ChallengeModeRequestLeaders, &WorldSession::HandleChallengeModeRequestLeaders);
    DEFINE_HANDLER(CMSG_CHALLENGE_MODE_REQUEST_MAP_STATS,                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::ChallengeMode::ChallengeModeRequestMapStats, &WorldSession::HandleChallengeModeRequestMapStats);
    ...
    DEFINE_HANDLER(CMSG_GET_CHALLENGE_MODE_REWARDS,                         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::ChallengeMode::GetChallengeModeRewards, &WorldSession::HandleGetChallengeModeRewards);
    ...
    DEFINE_HANDLER(CMSG_RESET_CHALLENGE_MODE,                               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::ChallengeMode::ResetChallengeMode, &WorldSession::HandleResetChallengeModeOpcode);
...
#define DEFINE_SERVER_OPCODE_HANDLER(opcode, status, con) \
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CHALLEGE_MODE_REWARDS,                   STATUS_NEVER,        CONNECTION_TYPE_REALM);
